...
import com.example.pilotpal.databinding.ActivityTafWebviewBinding;
import java.util.Objects;

public class TafWebview extends AppCompatActivity {
    ActivityTafWebviewBinding view;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        view = ActivityTafWebviewBinding.inflate(getLayoutInflater());
