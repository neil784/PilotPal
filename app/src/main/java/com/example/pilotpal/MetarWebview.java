...
import com.example.pilotpal.databinding.ActivityMetarWebviewBinding;
import java.util.Objects;

public class MetarWebview extends AppCompatActivity {
    ActivityMetarWebviewBinding view;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        view = ActivityMetarWebviewBinding.inflate(getLayoutInflater());
        ...
        String url = "https://www.checkwx.com/weather/" + icao + "/metar";
